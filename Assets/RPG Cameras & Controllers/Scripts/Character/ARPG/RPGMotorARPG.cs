...
namespace JohnStairs.RCC.Character.ARPG {
    ...
    public class RPGMotorARPG : RPGMotor {
        ...
        protected override void SetAnimatorParameters() {
            ...
            _animator.SetFloat("Input Magnitude", inputMagnitude, inputMagnitudeSmoothing, Time.deltaTime);
            _animator.SetFloat("Turning Direction", _turningDirectionY, 0.1f, Time.deltaTime);
