...
namespace JohnStairs.RCC.Character.MMO {
    ...
    public class RPGMotorMMO : RPGMotor {
        ...
        protected override void SetAnimatorParameters() {
            ...
            _animator.SetFloat("Input Direction X", _inputDirection.x, 0.1f, Time.deltaTime);
            _animator.SetFloat("Input Direction Z", _inputDirection.z, 0.1f, Time.deltaTime);
            _animator.SetFloat("Input Magnitude", _inputDirection.magnitude);
            _animator.SetFloat("Turning Direction", _yRotation, 0.1f, Time.deltaTime);
        }
